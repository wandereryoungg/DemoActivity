...
public class MediaCodecWrapper {
    ...
    private MediaCodecWrapper(MediaCodec codec) {
        ...
        Log.e(TAG, "mInputBuffers length: " + mInputBuffers.length);
        Log.e(TAG, "mOutputBuffers length: " + mOutputBuffers.length);
    ...
    public boolean writeSample(final MediaExtractor extractor,
        ...
        if (!mAvailableInputBuffers.isEmpty()) {
            Log.e(TAG, "mAvailableInputBuffers is not null");
            ...
            Log.e(TAG, "mAvailableInputBuffers is null");
        }
        return result;
    }
